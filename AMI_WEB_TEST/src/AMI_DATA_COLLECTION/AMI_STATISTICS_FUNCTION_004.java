...
public class AMI_STATISTICS_FUNCTION_004 {
	...
	public void main() throws InterruptedException 
	{
		...
		webDriver.findElement(By.xpath("//*[@onclick = 'showDetail(this,-1,-1)']")).click();
		
		webDriver.switchTo().defaultContent();
		webDriver.switchTo().frame("mainModalIframe");
		
		webDriver.findElement(By.xpath("(//[text() = 'Cancel'])")).click();
