...
public class AMI_ACQUISITION_TASK_FUNCTION_001 {
	...
	public void main() throws InterruptedException 
	{
		...
		webDriver.findElement(By.cssSelector("div.btn")).click();
		
		new Select(webDriver.findElement(By.xpath("//select[@id='userType']"))).selectByValue("2");
		webDriver.findElement(By.xpath("//input[@id='DESCRIPTION']")).sendKeys("test");
		
		element = webDriver.findElement(By.xpath("//input[@id='START_TIME']"));
		element.clear();
		element.sendKeys("2017-11-10 08:08:08");
		
		element = webDriver.findElement(By.xpath("//input[@id='END_TIME']"));
		element.clear();
		element.sendKeys("2017-12-10 08:08:08");
		
		webDriver.findElement(By.xpath("//*[@onclick = 'addField()']")).click();
		
		webDriver.switchTo().defaultContent();
		webDriver.switchTo().frame("modalBody");
		
		webDriver.findElement(By.className("field-item"));
		
		webDriver.findElement(By.xpath("//*/div/ul[@index ='0']"));
		
		webDriver.switchTo().parentFrame();
		webDriver.findElement(By.xpath("//*[@type = 'button' and text() = 'Cancel']"));
